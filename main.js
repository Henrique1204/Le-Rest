...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return Adicionar; });\n/* harmony import */ var _Utilitarios_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Utilitarios.js */ \"./js/modules/Utilitarios.js\");\n\r\n\r\nclass Adicionar {\r\n    constructor(seletor){\r\n        this.form = document.querySelector(seletor);\r\n        this.btn = document.querySelector(`${seletor} [type=\"button\"]`);\r\n        this.util = new _Utilitarios_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]();\r\n\r\n        this.addEvento = this.addEvento.bind(this);\r\n    }\r\n\r\n    adicionarDados() {\r\n        const token = sessionStorage.getItem(\"token\");\r\n\r\n        fetch('http://localhost:3001/pratos', {\r\n            method: \"POST\",\r\n            body: JSON.stringify(this.util.coletarDados(this.form)),\r\n            headers: {\r\n                \"Content-type\": \"application/json; charset=UTF-8\",\r\n                \"x-access-token\": token\r\n            }\r\n        });\r\n    }\r\n\r\n    addEvento(){\r\n        this.btn.addEventListener(\"click\", (e) => {\r\n            e.preventDefault();\r\n\r\n            if(this.util.validarCampos(this.form)){\r\n                this.adicionarDados();\r\n            }\r\n\r\n        })        \r\n    }\r\n\r\n    iniciar() {\r\n        if (this.form && this.btn) {\r\n            this.addEvento();\r\n        }\r\n\r\n        return this;\r\n    }\r\n}\r\n\n\n//# sourceURL=webpack:///./js/modules/Adicionar.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return App; });\n/* harmony import */ var _Modal_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Modal.js */ \"./js/modules/Modal.js\");\n/* harmony import */ var _Utilitarios_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Utilitarios.js */ \"./js/modules/Utilitarios.js\");\n/* harmony import */ var _Login_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Login.js */ \"./js/modules/Login.js\");\n/* harmony import */ var _Busca_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Busca.js */ \"./js/modules/Busca.js\");\n/* harmony import */ var _Deletar_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Deletar.js */ \"./js/modules/Deletar.js\");\n/* harmony import */ var _Adicionar_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Adicionar.js */ \"./js/modules/Adicionar.js\");\n/* harmony import */ var _Atualizar_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Atualizar.js */ \"./js/modules/Atualizar.js\");\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nclass App {\r\n    login() {\r\n        new _Modal_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"](\"login\").iniciar();\r\n        new _Login_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"] (\"#login\").iniciar(); \r\n    }\r\n\r\n    async buscar() {\r\n        // Cria os elementos.\r\n        const cards = await new _Busca_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"]().criarCards();\r\n\r\n        // Adiciona os cards no container main.\r\n        cards.forEach((card) => document.querySelector(\".container-card\").appendChild(card));\r\n    }\r\n\r\n    atualizar() {\r\n        const btns = document.querySelectorAll('[data-btn=\"atualizar\"]');\r\n        \r\n        btns.forEach((btn) => {\r\n            btn.addEventListener(\"click\", (e) => {\r\n                const dados = new _Utilitarios_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"]().puxarValores(e);\r\n                const modalElemento = document.querySelector('[data-modal=\"atualizar\"]');\r\n                \r\n                modalElemento.querySelector('[name=\"nome\"]').value = dados[\"nome\"];\r\n                modalElemento.querySelector(`option[value=\"${dados[\"categoria\"]}\"]`).setAttribute(\"selected\", \"\");\r\n                modalElemento.querySelector('[name=\"descricao\"]').value = dados[\"descricao\"];\r\n                \r\n                new _Atualizar_js__WEBPACK_IMPORTED_MODULE_6__[\"default\"](\"#atualizar_item\", dados[\"id\"]).iniciar();\r\n            });\r\n        });\r\n    }\r\n\r\n    deletar() {\r\n        const btns = document.querySelectorAll('[data-btn=\"deletar\"]');\r\n\r\n        btns.forEach((btn) => {\r\n            btn.addEventListener(\"click\", (e) => {\r\n                new _Deletar_js__WEBPACK_IMPORTED_MODULE_4__[\"default\"](\".opcoes\", new _Utilitarios_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"]().puxarId(e)).iniciar();\r\n            });\r\n        });\r\n    }\r\n\r\n    adicionar() {\r\n        new _Modal_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"](\"adicionar\").iniciar();\r\n        new _Adicionar_js__WEBPACK_IMPORTED_MODULE_5__[\"default\"](\"#adicionar_item\").iniciar();\r\n    }\r\n\r\n    async iniciar() {\r\n        const token = sessionStorage.getItem(\"token\");\r\n            \r\n        if (token) {\r\n            document.body.classList.add(\"logado\");\r\n\r\n            await this.buscar();\r\n\r\n            // Para a animação de loading\r\n            document.querySelector(\"main\").classList.remove(\"carregando\");\r\n\r\n            this.adicionar();\r\n            this.atualizar();\r\n            this.deletar();\r\n        } else {\r\n            document.body.classList.remove(\"logado\");\r\n    \r\n            this.login();\r\n        }\r\n    }\r\n}\r\n\n\n//# sourceURL=webpack:///./js/modules/App.js?");

/***/ }),

/***/ "./js/modules/Atualizar.js":
/*!*********************************!*\
  !*** ./js/modules/Atualizar.js ***!
  \*********************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_App_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/App.js */ \"./js/modules/App.js\");\n\r\n\r\nnew _modules_App_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]().iniciar();\r\n\n\n//# sourceURL=webpack:///./js/script.js?");
