...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_Modal_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/Modal.js */ \"./js/modules/Modal.js\");\n/* harmony import */ var _modules_Utilitarios_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/Utilitarios.js */ \"./js/modules/Utilitarios.js\");\n/* harmony import */ var _modules_Login_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/Login.js */ \"./js/modules/Login.js\");\n/* harmony import */ var _modules_Busca_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/Busca.js */ \"./js/modules/Busca.js\");\n/* harmony import */ var _modules_Deletar_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/Deletar.js */ \"./js/modules/Deletar.js\");\n/* harmony import */ var _modules_Adicionar_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/Adicionar.js */ \"./js/modules/Adicionar.js\");\n/* harmony import */ var _modules_Atualizar_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/Atualizar.js */ \"./js/modules/Atualizar.js\");\n// Importa o arquivo modal.js\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nconst util = new _modules_Utilitarios_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"]();\r\n\r\nfunction iniciarModais() {\r\n    // Seleciona os botões que ativam o modal...\r\n    // ...e retorna uma nodeList com os elementos html.\r\n    const btns = document.querySelectorAll(\"[data-btn]\");\r\n    \r\n    // Percorre a nodeList e para cada item executa a função.\r\n    btns.forEach((btn) => {\r\n        // Pega o valor do data-btn e passa na variável.\r\n        const modalNome = btn.dataset.btn;\r\n        \r\n        // Instância o objeto Modal e inicia ele.\r\n        const modal = new _modules_Modal_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"](`[data-modalContainer=\"${modalNome}\"]`, `[data-modal=\"${modalNome}\"]`).iniciar();\r\n        \r\n        // Adiciona o evento de click no botão.\r\n        // Executa o método ativarModal da classe Modal (Arquivo ./modules/modal.js Linha 14).\r\n        // btn.addEventListener(\"click\", modal.ativarModal);\r\n        \r\n        if (modalNome === \"atualizar\") {\r\n            btn.addEventListener(\"click\", (e) => {\r\n                const dados = util.puxarValores(e);\r\n                const modalElemento = document.querySelector(`[data-modal=\"${modalNome}\"]`);\r\n                \r\n                modalElemento.querySelector('[name=\"nome\"]').value = dados[\"nome\"];\r\n                modalElemento.querySelector(`option[value=\"${dados[\"categoria\"]}\"]`).setAttribute(\"selected\", \"\");\r\n                modalElemento.querySelector('[name=\"descricao\"]').value = dados[\"descricao\"];\r\n                \r\n                new _modules_Atualizar_js__WEBPACK_IMPORTED_MODULE_6__[\"default\"](\"#atualizar_item\", dados[\"id\"]).iniciar();\r\n            });\r\n        }\r\n        \r\n        if (modalNome === \"deletar\") {\r\n            btn.addEventListener(\"click\", (e) => {\r\n                const btnNao = document.querySelector(`[data-modal=\"${modalNome}\"] #nao`);\r\n                \r\n                btnNao.addEventListener(\"click\", modal.fecharModal);\r\n                \r\n                new _modules_Deletar_js__WEBPACK_IMPORTED_MODULE_4__[\"default\"](\".opcoes\", util.puxarId(e)).iniciar();\r\n            });\r\n        }\r\n    });\r\n}\r\n\r\nasync function iniciar() {\r\n    const token = sessionStorage.getItem(\"token\");\r\n    \r\n    if (token) {\r\n        document.body.classList.add(\"logado\");\r\n        \r\n        // Cria os elementos.\r\n        const cards = await new _modules_Busca_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"]().criarCards();\r\n        \r\n        // Adiciona os cards no container main.\r\n        cards.forEach((card) => document.querySelector(\".container-card\").appendChild(card));\r\n        \r\n        // Para a animação de loading\r\n        document.querySelector(\"main\").classList.remove(\"carregando\");    \r\n        \r\n        new _modules_Adicionar_js__WEBPACK_IMPORTED_MODULE_5__[\"default\"](\"#adicionar_item\").iniciar();\r\n    } else {\r\n        document.body.classList.remove(\"logado\");\r\n        \r\n        new _modules_Login_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"] (\"#login\").iniciar();\r\n    }\r\n    \r\n    iniciarModais();\r\n}\r\n\r\niniciar();\r\n\n\n//# sourceURL=webpack:///./js/script.js?");
